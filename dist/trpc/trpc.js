...
exports.publicProcedure = t.procedure; // anyone could call this api endpoint
exports.privateProcedure = t.procedure.use(isAuth); // .use() same like express middleware
