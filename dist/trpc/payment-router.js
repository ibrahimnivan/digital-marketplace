...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure // from ./trpc
                ...
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, stripe_1.stripe.checkout.sessions.create({
                                ...
                                cancel_url: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/cart"), // if anything goes wrong take back to checkout page again
