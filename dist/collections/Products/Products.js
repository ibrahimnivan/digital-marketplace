...
var syncUser = function (_a) {
    var // after product is created (who's user that created new product)
    req = _a.req, doc = _a.doc;
    return __awaiter(void 0, void 0, void 0, function () {
...
var isAdminOrHasAccess = // only admin and owner 
 function () {
    return function (_a) {
...
exports.Products = {
    ...
    fields: [
        ...
        },
        {
            ...
            label: "Category",
            type: "select",
            options: config_1.PRODUCT_CATEGORIES.map(
            // from config
            function (_a) {
